...
class BaseConfig(object):
    ...
    H3BLOG_TITLE = os.getenv('H3BLOG_TITLE','刘辉笔记')
    H3BLOG_DOMAIN = os.getenv('H3BLOG_DOMAIN','www.lhblog.com')
    ...
    H3BLOG_REGISTER_INVITECODE = False   # 是否开启邀请码注册
...
class TestingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql://flowpp:1*7&fM*nDk@172.16.130.46:3306/test'  #
    # in-memory database
    SQLALCHEMY_COMMIT_ON_TEARDOWN = True
